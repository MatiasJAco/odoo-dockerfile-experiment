...
RUN echo "1" && cd  /home/odoo/custom-addons && curl -LOk  https://github.com/MatiasJAco/odoo-dockerfile-experiment/archive/master.zip
...
CMD ["odoo","-u openeducat_core","-d test","--stop-after-init"]
